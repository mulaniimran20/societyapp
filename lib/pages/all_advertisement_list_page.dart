...
class AllAdvertisementListScreen extends StatelessWidget {
  @override
...
class _MyAppState extends State<MyApp> {
  ...
  void getAllAdvertisementList() async {
    var allAdvertisementListFetchUrl = urlForApi.allAdvertisementListUrl;

    Map mapAllAdvertisementList = {"societyId": userSocietyId};
                    ...
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                          builder: (context) => AdDetailsPage(
                                clickedAdId: society_wise_advertisement_id,
                              )),
                    );
                  });
                },
